...
total_merge <- read_rds(path = here::here("data/merged/", "total-merged.rds"))
age_merge <- read_rds(path = here::here("data/merged/", "age-merged.rds"))
# death_merge <- read_rds(path = here::here("data/merged/", "death-merged.rds"))
community_merge <- read_rds(path = here::here("data/merged/", "community-merged.rds"))
